...
using Tyuiu.KomarovaMV.Sprint0.Task7.V0.Lib;

namespace Tyuiu.KomarovaMV.Sprint0.Task7.V0
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Ошибка! Исходные массивы имеют разное количество эллементов");
            }
            Console.ReadKey();
        }
    }
